...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SonyGamepadSenors", meta = (AdvancedDisplay = "Calibration Duration (Seconds)", ToolTip = "Initiates the motion sensor calibration process for the specified controller. The calibration adjusts the motion sensor sensitivity and dead zone settings."))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SonyGamepadSenors", meta = (ToolTip = "True if the calibration process is in progress, false otherwise."))
